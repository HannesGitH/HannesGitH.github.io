...
const allEducation:EducationEntry[] = [
    ...
    { year: 2023, degree: 'M.Sc.', gpa:'expecting ~1.7', place: 'Freie Universität Berlin', location:'Berlin, DE', name:'Computer Science',description:'i\'ve already finished all my classes since 2021, but i\'m still writing my master thesis on quantum computer algorithms, which i expect to finish 2023. It takes some time since im mostly occupied with my jobs as you can see in the next section.'}
];
